...
test_that("read time series data (data2d)", 
{
    ...
    p1_heartr <- ccd@patients[[1]]@episodes[[1]]@data$NIHR_HIC_ICU_0108
    p2_heartr <- ccd@patients[[2]]@episodes[[1]]@data$NIHR_HIC_ICU_0108
    ...
    expect_identical(table$data2d$pas_number,
                     c(rep(ccd@patients[[1]]@episodes[[1]]@pas_number, l1),
                       rep(ccd@patients[[2]]@episodes[[1]]@pas_number, l2)))
